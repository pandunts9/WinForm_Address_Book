...
namespace Address_Book.MyDataBaseTableAdapters {
...
SELECT Id, FirstName, LastName, Phone, Email, Address FROM AddressBook WHERE (Id = @Id)";
        ...
        public virtual int Fill(MyDataBase.AddressBookDataTable dataTable) {
        ...
        public virtual MyDataBase.AddressBookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDataBase.AddressBookDataTable dataTable = new MyDataBase.AddressBookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDataBase.AddressBookDataTable dataTable) {
